    ...
    public class EmailSenderServiceTests
    {
        ...
        public void Setup()
        {
            ...
            var configuration = new ConfigurationBuilder()
                ...
                {
                    new KeyValuePair<string, string>("SendGrid:ApiKey", "YOUR_REAL_API_KEY") 
                })
                .Build();

            emailSenderService = new EmailSenderService(configuration);
            SeedData();
        }
        ...
        public async Task SendEmailAsync_ShouldSendEmailSuccessfully()
        {
            ...
            await emailSenderService.SendEmailAsync(toEmail, subject, message);

            Assert.Pass("Email sent successfully.");
        }
